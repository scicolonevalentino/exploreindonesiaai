// Monochrome brand marks for the "Also works inside ChatGPT and Claude" badge
// and the /connect guide. They inherit the surrounding text color via
// `fill="currentColor"`, so they stay quiet against the cream card and never
// fight the site palette. Official company logomarks (OpenAI, Anthropic).
